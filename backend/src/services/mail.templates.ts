    ...
    passwordReset: (url: string) => ({
        ...
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
                ...
                <p>Hola,</p>
                <p>Has solicitado restablecer tu contraseña para acceder a <strong>TFG</strong>. Haz clic en el botón de abajo para continuar:</p>
                ...
                <p style="color: #999; font-size: 0.8em; text-align: center;">© 2026 TFG. Todos los derechos reservados.</p>
            </div>
        `
    })
};
